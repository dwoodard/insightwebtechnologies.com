...
<template>
    <BlankLayout title="Privacy Policy - Insight Web Technologies">
        <Head>
            <meta
                name="description"
                content="Learn about how Insight Web Technologies collects, uses, and protects your personal information."
            />
        </Head>
        ...
        <section class="container mx-auto px-4 py-20">
            <div class="mx-auto max-w-3xl">
                ...
                <div class="space-y-8 text-gray-700">
                    <p>
                        Insight Web Technologies ("we," "our," or "us") respects
                        your privacy and is committed to protecting the personal
                        information you provide when using our website and
                    ...
                    <div>
                        ...
                        <ul class="mb-6 list-inside list-disc space-y-2">
                            ...
                            <li>
                                Register for events, classes, or conferences
                            </li>
                        ...
                        <p class="mb-3">
                            ...
                            automatically when you visit our website, such as:
                        </p>
                    ...
                    <div>
                        ...
                        <p class="mb-3">
                            We use the information we collect for purposes such
                            as:
                        </p>
                        <ul class="list-inside list-disc space-y-2">
                            ...
                            <li>
                                Sending updates, educational content, or event
                                announcements
                            </li>
                            <li>Improving our website and user experience</li>
                            <li>Providing customer support</li>
                            <li>
                                Communicating with you via email, phone, or SMS
                                if you request contact
                            </li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="mb-3">
                            If you choose to provide your phone number, you may
                            receive communications from Insight Web Technologies
                            related to:
                        </p>
                        <ul class="mb-4 list-inside list-disc space-y-2">
                        ...
                        <ul class="list-inside list-disc space-y-2">
                            ...
                            <li>
                                You may request assistance by replying HELP or
                                contacting us directly.
                            </li>
                            <li>
                                We do not sell, rent, or share your phone number
                    ...
                    <div>
                        ...
                        <p class="mb-3">
                            ...
                            services that help operate our business, such as:
                        </p>
                        <ul class="mb-4 list-inside list-disc space-y-2">
                            <li>Website hosting providers</li>
                            <li>Marketing or CRM platforms</li>
                            <li>Communication tools</li>
                            <li>Analytics providers</li>
                        </ul>
                        <p>
                            These providers are required to protect your
                            information and use it only for the purposes of
                    ...
                    <div>
                        ...
                        <p>
                            ...
                            and physical safeguards to help protect your
                            personal information. However, no online
                    ...
                    <div>
                        ...
                        <p>
                            You can adjust your browser settings to refuse
                    ...
                    <div>
                        ...
                        <p>
                            To make a request, please contact us using the
                            information below.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <p>
                            ...
                            Any updates will be posted on this page with the
